 ...
 */
package com.android.settings.libremobileos.utils;
...
public class DeviceUtils {
    ...
    /* returns whether the device supports keyboard backlight adjustment or not. */    public static boolean hasKeyboardBacklightSupport(Context context) {
