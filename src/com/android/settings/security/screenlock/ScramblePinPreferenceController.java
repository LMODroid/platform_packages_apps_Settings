...
public class ScramblePinPreferenceController extends AbstractPreferenceController
    ...
    public void updateState(Preference preference) {
        int value = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.LOCKSCREEN_PIN_SCRAMBLE_LAYOUT, 0, UserHandle.USER_CURRENT);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putIntForUser(
                mContext.getContentResolver(), Settings.System.LOCKSCREEN_PIN_SCRAMBLE_LAYOUT, value ? 1 : 0, UserHandle.USER_CURRENT);
        return true;
    }
